...
function CheckOrderScreen({match}) {
    ...
    return (
        ...
        //             <Col sm="6">
        //             <Form.Label column sm="6">
        //             {parseFloat(prescription.total_price).toFixed(0).replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')} VNĐ
        //             </Form.Label>
        //             </Col>
        //         </Form.Group>
        ...
        //             <Col sm="6">
        //             <Form.Label column sm="6">
        //             {parseFloat(prescription.expense).toFixed(0).replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')} VNĐ
        //             </Form.Label>
        //             </Col>
        //         </Form.Group>
        ...
        //             <Col sm="6">
        //             <Form.Label column sm="6">
        //             {(parseFloat(prescription.total_price)+parseFloat(prescription.expense)).toFixed(0).replace(/(\d)(?=(\d{3})+(?!\d))/g, '$1,')} VNĐ
        //             </Form.Label>
        //             </Col>
        //         </Form.Group>
